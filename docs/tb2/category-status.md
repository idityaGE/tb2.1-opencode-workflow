...
| Policy | Status | Since |
|---|---|---|
| `allow_internet = true` | ✅ Allowed when genuinely required (eval-checked) | Jul 13, 2026 |
| `codebase_size = "minimal"` | ✅ Re-allowed | May 11, 2026 |
| Base images | ✅ Canonical list preferred; non-canonical needs justification | Jun 12, 2026 |

See the category definitions in [Task Taxonomy](/portal/docs/understanding-tasks/task-taxonomy) and policy details in [Dockerfile Best Practices](/portal/docs/creating-tasks/dockerfile-best-practices).
